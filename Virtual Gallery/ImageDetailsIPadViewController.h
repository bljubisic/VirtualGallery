//
//  ImageDetailsIPadViewController.h
//  Virtual Gallery
//
...
@interface ImageDetailsIPadViewController : UIViewController <UIGestureRecognizerDelegate, UIScrollViewDelegate, ImageModelDelegate> {
